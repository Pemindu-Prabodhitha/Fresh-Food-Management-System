...
<body class="landing-body">
    ...
    <div style="flex-grow: 1; display: flex; align-items: center; justify-content: center; padding: 20px;">
        <div class="auth-container" style="width: 100%; margin: 0;">
            <h2 style="color: lightgreen; margin-top: 0; margin-bottom: 20px;">Create an Account</h2>
            
            <?php
            if (isset($_SESSION['signup_success'])) {
                echo '<div style="background-color: #2e4a29; color: #8ce67c; padding: 12px; border-radius: 4px; margin-bottom: 15px; border: 1px solid #3a5e35; text-align: center;">' . $_SESSION['signup_success'] . '<br><a href="login.php" style="color: white; font-weight: bold; text-decoration: underline;">Click here to Login</a></div>';
                unset($_SESSION['signup_success']);
            }
            if (isset($_SESSION['signup_error'])) {
                echo '<div style="background-color: #3a1c1c; color: #ff6b6b; padding: 12px; border-radius: 4px; margin-bottom: 15px; border: 1px solid #ff6b6b; text-align: center;">' . $_SESSION['signup_error'] . '</div>';
            ...
            <form id="signup-form" action="signup_action.php" method="POST" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="signup-location" name="location_city" class="form-control">
                </div>

                <button type="submit" class="btn btn-success" style="margin-top: 10px;">Register Account</button>
            </form>
            <p style="text-align: center; margin-top: 20px; color: #888;">Already have an account? <a href="login.php" style="color: lightgreen; text-decoration: none;">Login here</a></p>
        </div>
    </div>
